			...
			<div className="wrapper pb-12 md:pb-20">
				...
				<div className="grid grid-cols-1 gap-4 md:grid-cols-[10fr_8fr] md:gap-8">
					<div className="space-y-4 self-center py-4 md:py-12">
						<p>
							At Cleopatra Trading Co., we specialize in sourcing and delivering vehicles and spare parts worldwide.
							Based in Incheon, South Korea, we provide a seamless experience for customers looking for Korean, German,
							American, and other top-brand vehicles. Our team ensures secure container loading and efficient global
							shipping.
						</p>
						<p>
							With multilingual support in Korean, English, Arabic, and Russian, we are committed to offering reliable
							and professional service to clients worldwide. Whether you need a fully assembled car or specific parts,
							we guarantee quality and satisfaction every step of the way.
						</p>
					</div>
